...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery.min.js"></script>
	...
	<div id="bgi"  style="background-color:#CCFFCC; height: 100%" >
						...
						<a class="page-header" href="#"><h4><b>院系信息</b></h4></a>
						<ol>
							<h5>&nbsp;</h5>
						</ol>
						
						<h4>1. <a id="proveForStu"   href="addOneCollege.jsp" target="main1">院系增加</a></h4>
						<h4>2. <a   href="${pageContext.request.contextPath}/CollegeController/queryAllCollege.do" target="main1">院系查询</a></h4>
						<h4>3. <a   href="${pageContext.request.contextPath}/MajorController/AddMajorInfo.do" target="main1">专业添加</a></h4>
						<h4>4. <a   href="${pageContext.request.contextPath}/MajorController/findAllMajorList.do" target="main1">专业查询</a></h4>
	</div>
<body>
