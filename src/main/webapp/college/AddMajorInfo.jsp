...
<body>
	...
	%>
	<form
		action="${pageContext.request.contextPath}/MajorController/addOneMajor.do"
		...
		<tr>
			...
			<td style="font-weight: bold">专业名称:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td><input type="text" class="form-control" name="major_name" required></td>
			</tr>
			</table>
		</div>
		<div class="form-gruop" style="margin-bottom: 30px">
		...
		<tr>
			...
			<td>
			<select name="college.college_id"
