...
<table class="table " border="1" id="tb">
		<tr> 
		 ...
		 <jstl:forEach  items="${listPlanCourse}" var="plan">
			<tr>
				...
				<td><a href="${pageContext.request.contextPath}/OpenCourseController/queryOnePlanCourseById.do?courseId=${plan.courseId}&&classId=${plan.classId}&&isplaned=${plan.isplaned}" class="btn btn-primary">添加开课任务</a>
				<a href="${pageContext.request.contextPath}/OpenCourseController/deleteOnePlanCourseById.do?courseId=${plan.courseId}&&classId=${plan.classId}&&isplaned=${plan.isplaned}" class="btn btn-danger">删除</a>
				</td>
			</tr>
		</jstl:forEach> 
